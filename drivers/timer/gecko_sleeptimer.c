...
#ifndef CONFIG_SYS_PM_STATE_LOCK
#error CONFIG_SYS_PM_STATE_LOCK needed to retain 32khz clocks during sleep
#endif
#endif
#endif

#if defined(CONFIG_GECKO_SLEEPTIMER_ULFRCO) && CONFIG_SYS_CLOCK_TICKS_PER_SEC > 1000
#error ULFRCO maximum resolution is 1khz
#elif CONFIG_SYS_CLOCK_TICKS_PER_SEC > 32768
#error LFXO and LFRCO maximum resolution is 32khz
#endif
